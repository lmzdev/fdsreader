...
<main>
  <div class="container-top container">
    ...
    />
    <button
      style="display: {fdsOutput === '' ? 'block' : 'none'}"
      on:click={clickConvert}
      disabled={!Converter.validate(fdsInput)}
    >
      Konvertieren
    </button>
  </div>
  <div class="container container-bot">
    ...
    >
      <button
        ...
        data-tooltip="Text Kopieren"
        data-placement="left"><Copy size={20} /></button
      >
      {fdsOutput}
